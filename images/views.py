...
def image_list(request):
    """List Image view"""
    images = Image.objects.all()  # query all images
    paginator = Paginator(images, 8)  # create paginator object with 8items/page
    page = request.GET.get('page')  # get page query param
    try:
